...
def get_connection(autocommit: bool = True) -> MySQLConnection:
  ...
  db_conf = {
    ...
    "database": "ch_no_weight", #config.TIDB_DB_NAME,
...
class Workload_Parameter:
  def __init__(self):
    ...
    self.sql_file_path = 'workload_no_weight.sql'
...
def test_ap(max_qry_cnt):
  ...
  while True:  
    with get_connection(autocommit=False) as connection:
      with connection.cursor() as cur: 
        # cur.execute("SET SESSION tidb_mem_quota_query = 4 * 1024 * 1024 * 1024")
  ...
  def generate_payment(self):
    ...
    with get_connection(autocommit=False) as connection:
      with connection.cursor() as cur: 
        ...
        sql_payment4 = """
          INSERT INTO history_part2 (h_data, h_c_id, h_c_d_id, h_c_w_id, h_d_id, h_w_id, h_date)
          VALUES ('{}', {}, {}, {}, {}, {}, NOW());
        """.format(h_data, c_id, c_d_id, c_w_id, d_id, w_id)
        #print(sql_payment4)
        cur.execute(sql_payment4)
    
        sql_payment4 = """
          INSERT INTO history_part1 (h_c_id, h_c_d_id, h_c_w_id, h_d_id, h_w_id, h_date, h_amount)
          VALUES ({}, {}, {}, {}, {}, NOW(), {});
        """.format(c_id, c_d_id, c_w_id, d_id, w_id, payment_amount)
        cur.execute(sql_payment4)        
...
if __name__ == '__main__':
  ...
  # 每个线程测试300条txn，1000条sql，txn并发度是1
  # test_query_latency_with_tp(100, 5000, 1)
