...
WITH /*PLACEHOLDER*/ /*trending-repos-past_24_hours-Clojure.sql*/ stars AS (
  SELECT
...
SELECT /*PLACEHOLDER*/ /*trending-repos-past_24_hours-Clojure.sql*/ 
    tr.repo_id,
    tr.repo_name,
