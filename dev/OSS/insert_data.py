        ...
        with connection.cursor() as cur:
            try:
                ...
                while current_start < end_id:
                    ...
                    print(f"Inserting repo_id from {current_start} to {current_end}...")

                    insert_sql = f"""
                        INSERT INTO github_repos_partitioned
                        SELECT * FROM github_repos
                        WHERE repo_id >= {current_start} AND repo_id < {current_end};
                    """
...
if __name__ == "__main__":
    batch_insert(start_id=33000001, end_id=531598801)
